...
public class MyHttpLoggingInterceptor implements Interceptor {
    ...
    public interface Logger {
        ...
        MyHttpLoggingInterceptor.Logger DEFAULT = message -> Platform.get().log(message, Platform.INFO, null);
    }
    ...
    protected  MyHttpLoggingInterceptor.Logger logger;

    protected volatile MyHttpLoggingInterceptor.Level level = MyHttpLoggingInterceptor.Level.NONE;
